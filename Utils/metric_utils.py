...
def visualization(ori_data, generated_data, analysis, compare=3000, pdf = None):
  ...
  """
    ...
    if analysis == 'pca':
        ...
        sns.distplot(prep_data_hat, hist=False, kde=True, kde_kws={'linewidth': 2, 'linestyle':'--'}, label='Synthetic', color="blue")
        # Plot formatting
